...
public class AddressListPanel extends javax.swing.JPanel {
    ...
    public int setSelectionWithID(int id){
        ListEntry le;
        boolean found = false;
        for(int i=0; i< addressList.getModel().getSize() ; i++){
            le = (ListEntry)addressList.getModel().getElementAt(i);
            if(id==le.getId()){
...
//    public boolean setSelectionWithName(String name){
//        ListEntry le;
//        boolean found = false;
//        for(int i=0; i< addressList.getModel().getSize() ; i++){
//            le = (ListEntry)addressList.getModel().getElementAt(i);
//            if(name.equals(le.getLastName())){
//                addressList.setSelectedIndex(i);
//                found = true;
//                break;
//            }
